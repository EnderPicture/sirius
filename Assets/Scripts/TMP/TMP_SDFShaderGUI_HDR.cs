...
{
    public class TMP_SDFShaderGUI_HDR : TMP_BaseShaderGUI
    {
        ...
        void DoFacePanel()
        {
            ...
            MaterialProperty color = FindProperty("_FaceColor", m_Properties);

            color.colorValue = EditorGUILayout.ColorField(
                new GUIContent("HDR Color"), color.colorValue,
                true, false, true);
